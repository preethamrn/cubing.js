...
NPM_COMMANDS = build build-parcel dev clean test test-jest test-node-require format setup lint prepack parcel-build-for-twizzle-net parcel-build-for-vr-cubing-net parcel-build-for-experiments-cubing-net
